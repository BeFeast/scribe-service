...
import type { LibraryLayout, ScribeDensity, ScribeTheme, ScribeVariant, Tweaks } from "../hooks/useTweaks";
  ...
  return (
    <aside className="tweaks-panel" aria-label="Tweaks">
      ...
      <div className="jump-row">
        <button type="button" className="jump-button" onClick={() => navigate({ page: "library", params: {} })}>
          Library
        </button>
        <button type="button" className="jump-button" onClick={() => navigate({ page: "queue", params: {} })}>
          Queue
        </button>
        <button type="button" className="jump-button" onClick={() => navigate({ page: "ops", params: {} })}>
          Ops
        </button>
      </div>
    </aside>
